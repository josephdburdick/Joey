...
class Logo extends React.Component {
  ...
  //   // }
  //   this.requestLogoImage = requestLogoImage.bind(this);
  ...
  render() {
    ...
    const svg = (
      <svg role="image" viewBox="0 0 1000 431.95">
        ...
        <defs id="defs6">
          <pattern id="graffiti" patternTransform="scale(1, -1)" patternUnits="userSpaceOnUse" width={this.props.width} height={this.props.height}>
            <image xlinkHref={this.props.url} x="0" y="0"
